...
# The donor's agent skill is archived beside this test, under
# archive/moneyprinterturbo/docs/skill/.
SKILL_SCRIPT = Path(__file__).resolve().parents[1] / "docs" / "skill" / "mpt_agent.py"
