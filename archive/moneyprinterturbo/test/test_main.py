...
# The donor entry point and this test are archived together; the engine they
# drive stays at the repository root.
...
def test_main_starts_uvicorn_with_runtime_config():
    ...
    with (
        ...
        runpy.run_path(str(ARCHIVE_DIR / "main.py"), run_name="__main__")
