...
| Unified Media Studio Template | service catalog, workflow installers, tests, cross-platform launchers | retired 2026-09-03; only its ComfyUI patches and the LTX 2.3 Eros anchor manifest survive, under `patches/` | Second product shell removed; patterns already assimilated |
