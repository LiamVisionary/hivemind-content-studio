---
name: clueso-one-rollout-every-department
description: >-
  Clueso MCP provider-specific adapter for the upstream one-rollout-every-department
...
# Clueso: One Rollout Every Department
...
Then read and apply
[../../upstream/one-rollout-every-department/SKILL.md](../../upstream/one-rollout-every-department/SKILL.md)
