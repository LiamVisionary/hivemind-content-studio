---
name: clueso-lecture-to-notes
description: >-
  Clueso MCP provider-specific adapter for the upstream lecture-to-notes
...
Then read and apply
[../../upstream/lecture-to-notes/SKILL.md](../../upstream/lecture-to-notes/SKILL.md)
