---
name: clueso-video-to-article
description: >-
  Clueso MCP provider-specific adapter for the upstream video-to-article
...
Then read and apply
[../../upstream/video-to-article/SKILL.md](../../upstream/video-to-article/SKILL.md)
