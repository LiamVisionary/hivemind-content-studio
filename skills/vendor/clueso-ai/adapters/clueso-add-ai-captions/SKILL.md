---
name: clueso-add-ai-captions
description: >-
  Clueso MCP provider-specific adapter for the upstream add-ai-captions
...
Then read and apply
[../../upstream/add-ai-captions/SKILL.md](../../upstream/add-ai-captions/SKILL.md)
