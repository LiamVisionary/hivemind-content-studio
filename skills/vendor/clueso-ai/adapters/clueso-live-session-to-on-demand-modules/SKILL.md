---
name: clueso-live-session-to-on-demand-modules
description: >-
  Clueso MCP provider-specific adapter for the upstream live-session-to-on-demand-modules
...
# Clueso: Live Session To On Demand Modules
...
Then read and apply
[../../upstream/live-session-to-on-demand-modules/SKILL.md](../../upstream/live-session-to-on-demand-modules/SKILL.md)
