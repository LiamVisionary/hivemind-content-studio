---
name: clueso-add-cta-end-card
description: >-
  Clueso MCP provider-specific adapter for the upstream add-cta-end-card
...
Then read and apply
[../../upstream/add-cta-end-card/SKILL.md](../../upstream/add-cta-end-card/SKILL.md)
