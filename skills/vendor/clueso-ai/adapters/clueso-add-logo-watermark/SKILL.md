---
name: clueso-add-logo-watermark
description: >-
  Clueso MCP provider-specific adapter for the upstream add-logo-watermark
...
Then read and apply
[../../upstream/add-logo-watermark/SKILL.md](../../upstream/add-logo-watermark/SKILL.md)
