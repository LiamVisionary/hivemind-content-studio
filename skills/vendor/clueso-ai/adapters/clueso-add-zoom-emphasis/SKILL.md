---
name: clueso-add-zoom-emphasis
description: >-
  Clueso MCP provider-specific adapter for the upstream add-zoom-emphasis
...
Then read and apply
[../../upstream/add-zoom-emphasis/SKILL.md](../../upstream/add-zoom-emphasis/SKILL.md)
