---
name: clueso-slides-to-video
description: >-
  Clueso MCP provider-specific adapter for the upstream slides-to-video
...
Then read and apply
[../../upstream/slides-to-video/SKILL.md](../../upstream/slides-to-video/SKILL.md)
