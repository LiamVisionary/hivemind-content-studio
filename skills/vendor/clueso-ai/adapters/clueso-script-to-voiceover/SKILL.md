---
name: clueso-script-to-voiceover
description: >-
  Clueso MCP provider-specific adapter for the upstream script-to-voiceover
...
Then read and apply
[../../upstream/script-to-voiceover/SKILL.md](../../upstream/script-to-voiceover/SKILL.md)
