---
name: clueso-apply-brand-colors
description: >-
  Clueso MCP provider-specific adapter for the upstream apply-brand-colors
...
Then read and apply
[../../upstream/apply-brand-colors/SKILL.md](../../upstream/apply-brand-colors/SKILL.md)
