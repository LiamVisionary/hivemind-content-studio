---
name: clueso-add-opening-hook
description: >-
  Clueso MCP provider-specific adapter for the upstream add-opening-hook
...
Then read and apply
[../../upstream/add-opening-hook/SKILL.md](../../upstream/add-opening-hook/SKILL.md)
