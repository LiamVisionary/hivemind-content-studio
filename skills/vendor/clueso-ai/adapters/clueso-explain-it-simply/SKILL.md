---
name: clueso-explain-it-simply
description: >-
  Clueso MCP provider-specific adapter for the upstream explain-it-simply
...
Then read and apply
[../../upstream/explain-it-simply/SKILL.md](../../upstream/explain-it-simply/SKILL.md)
