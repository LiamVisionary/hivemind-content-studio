---
name: clueso-batch-multi-language-export
description: >-
  Clueso MCP provider-specific adapter for the upstream batch-multi-language-export
...
# Clueso: Batch Multi Language Export
...
Then read and apply
[../../upstream/batch-multi-language-export/SKILL.md](../../upstream/batch-multi-language-export/SKILL.md)
