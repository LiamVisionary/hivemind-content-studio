...
def is_task_busy(task: dict | None) -> bool:
    ...
    # Only generation holds the task directory now. Render-time cross-posting
    # was removed: every outward post goes through the approval-gated publisher
    # in src/hivemind_content_studio/publishing.py instead.
