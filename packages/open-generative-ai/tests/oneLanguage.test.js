...
//
// Deliberately textual: these are absence claims over the whole tree — no
// language predicate survives, no toggle came back, no unlock reloads the
// page — and an absence is exactly what a render cannot show.
