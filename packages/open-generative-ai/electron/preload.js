...
contextBridge.exposeInMainWorld('localAI', {
    ...
    listLoraUpdates: async () => ({ updates: {} }),
    getCivitaiDownloadJob: async () => { throw new Error('Civitai downloads are available through Unified Studio.'); },
    cancelCivitaiDownload: async () => { throw new Error('Civitai downloads are available through Unified Studio.'); },
    ...
    warmIdeogram4: () => ipcRenderer.invoke('local-ai:ideogram4-warm'),
    unloadIdeogram4: () => ipcRenderer.invoke('local-ai:ideogram4-unload'),
