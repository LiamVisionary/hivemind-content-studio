...
// persist the same way once the hub layer exists.
export const STUDIO_PAGES = ['image', 'video', 'sprite', 'story', 'cinema', 'lipsync', 'restore'];
...
export function isKnownPage(page) {
  ...
  return STUDIO_PAGES.includes(page) || Object.hasOwn(HUB_PAGES, page);
}
