...
export const STRINGS = {
    ...
    'activity.subtitle': 'Productions and studio generations · local metadata, no prompts, media, credentials, or provider payloads',
    'activity.studioOrigin': 'Studio',
    'activity.emptyOutput': 'empty output',
    'activity.loras': (count, base) => `${count} LoRA${count === 1 ? '' : 's'}${base ? ` for ${base}` : ''}`,
    ...
    'activity.noAttemptsHint': 'Start a production or a studio generation and its attempts show up here as they run — refusals say why.',
