...
export const LOCAL_MODEL_CATALOG = [
    // ── Ideogram 4 — open-weight design/text-rendering model ────────────────
    {
        id: 'ideogram4-fp8',
        name: 'Ideogram 4',
        description: 'Open-weight 9.3B design model with best-in-class typography and structured JSON prompting. Runs through ~/voice-lab/ideogram4 on Apple Silicon MPS.',
        type: 'ideogram4',
        provider: 'ideogram4',
        sizeGB: 18.0,
        ...
        defaultSteps: 12,
        defaultGuidance: 7,
        defaultRuntimeMode: 'one-off',
        runtimeModes: [
            { id: 'one-off', label: 'One-off', description: 'Load for one image, then free RAM.' },
            { id: 'persistent', label: 'Keep loaded', description: 'Use the Apple Silicon MLX sidecar and keep weights warm.' },
        ],
        tags: ['design', 'typography', 'open-weight', 'local'],
        featured: true,
    },
