...
export const CAMERA_MOTIONS = Object.freeze([
  ...
  { id: 'handheld-zoom-in', label: 'Handheld push in', family: 'Handheld', glyph: '+', clause: 'push in with subtle handheld camera movement', step: 'a subtle handheld push in', detail: 'Move closer with natural operator movement', collection: 'Handheld & FPV' },
  { id: 'handheld-zoom-out', label: 'Handheld pull out', family: 'Handheld', glyph: '−', clause: 'pull back with subtle handheld camera movement', step: 'a subtle handheld pull back', detail: 'Move away with natural operator movement', collection: 'Handheld & FPV' },
  { id: 'handheld-orbit-ccw', label: 'Handheld orbit CCW', family: 'Handheld', glyph: '↺', clause: 'orbit counterclockwise with subtle handheld movement', step: 'a handheld counterclockwise orbit', detail: 'Circle the subject counterclockwise', collection: 'Handheld & FPV' },
  { id: 'handheld-orbit-cw', label: 'Handheld orbit CW', family: 'Handheld', glyph: '↻', clause: 'orbit clockwise with subtle handheld movement', step: 'a handheld clockwise orbit', detail: 'Circle the subject clockwise', collection: 'Handheld & FPV' },
  { id: 'handheld-zoom-orbit-ccw', label: 'Push + orbit CCW', family: 'Handheld', glyph: '↺', clause: 'push in while subtly orbiting counterclockwise with handheld movement', step: 'a handheld push in with a counterclockwise orbit', detail: 'Compound close move with a subtle arc', collection: 'Handheld & FPV' },
  { id: 'handheld-zoom-orbit-cw', label: 'Push + orbit CW', family: 'Handheld', glyph: '↻', clause: 'push in while subtly orbiting clockwise with handheld movement', step: 'a handheld push in with a clockwise orbit', detail: 'Mirrored compound close move', collection: 'Handheld & FPV' },
  { id: 'fpv-zoom-track-left', label: 'FPV push + track left', family: 'FPV', glyph: '↙', clause: 'push in with an FPV camera, then track left', step: 'an FPV push in followed by a track left', detail: 'Fast compound move with lateral tracking', collection: 'Handheld & FPV' },
  { id: 'fpv-zoom-track-right', label: 'FPV push + track right', family: 'FPV', glyph: '↘', clause: 'push in with an FPV camera, then track right', step: 'an FPV push in followed by a track right', detail: 'Mirrored compound move with lateral tracking', collection: 'Handheld & FPV' },
  { id: 'fpv-orbit-ccw', label: 'FPV orbit CCW', family: 'FPV', glyph: '↺', clause: 'perform a fast FPV drone orbit counterclockwise', step: 'a fast counterclockwise FPV drone orbit', detail: 'Aggressive cinematic orbit', collection: 'Handheld & FPV' },
  { id: 'fpv-orbit-cw', label: 'FPV orbit CW', family: 'FPV', glyph: '↻', clause: 'perform a fast FPV drone orbit clockwise', step: 'a fast clockwise FPV drone orbit', detail: 'Mirrored aggressive cinematic orbit', collection: 'Handheld & FPV' },
