  ...
  const download = async () => {
    ...
    if (result.ok) {
      ...
      if (result.method === 'clipboard') {
        toast.success('Could not write a file — the key is on your clipboard instead');
      }
      return;
    }
    if (result.cancelled) return;
    toast.error('Could not save a file — press Copy key and paste it into your password manager');
  };
