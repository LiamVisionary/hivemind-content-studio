      ...
      <form onSubmit={submit} className="flex flex-col gap-4">
        <div className="flex items-start gap-3 rounded-md border border-line1 bg-bg2 px-3.5 py-3">
          ...
          <p className="text-[13px] leading-relaxed text-ink2">
            Your media is end-to-end encrypted and the key lives only in an unlocked tab.
            This tab doesn&rsquo;t have it yet — enter your studio password to decrypt here.
          </p>
        </div>
        <Field label="Studio password" error={error}>
          <TextInput
            type="password"
            value={password}
