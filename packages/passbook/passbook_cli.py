...
ALIASES = {
    "passbook-check": "check",
    "passbook-add": "add",
    "passbook-set": "add",
    "passbook-remove": "remove",
    "passbook-delete": "remove",
    "passbook-run": "run",
    "passbook-list": "list",
    "passbook-status": "status",
    "passbook-access": "access",
    "passbook-seal": "seal",
    "passbook-link": "link",
    "passbook-broker": "broker",
    "passbook-unlock": "unlock",
    "passbook-lock": "lock",
    "passbook-approve": "approve",
}
