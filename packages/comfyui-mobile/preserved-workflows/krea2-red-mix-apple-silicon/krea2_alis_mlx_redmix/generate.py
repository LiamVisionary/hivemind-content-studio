...
def main():
    ...
    ap.add_argument("--precision", choices=["8bit", "mixed-4-8", "mxfp8", "mxfp8-fused", "bf16"], default=None,
    ...
    if precision in {"mxfp8", "mxfp8-fused"} and tpath is None:
        ap.error(f"--precision {precision} requires --transformer pointing at MXFP8 weights")
    if precision not in ("bf16", "mxfp8", "mxfp8-fused") and tpath is None:
