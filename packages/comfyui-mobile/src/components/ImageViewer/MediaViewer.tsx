...
interface MediaViewerProps {
  ...
  onCopyWorkflowDebug?: (item: ViewerImage) => void;
...
export function MediaViewer({
  ...
  const handleCopyWorkflowDebugClick = useCallback(() => {
    if (!currentItem) return;
    resetIdleTimer();
    onCopyWorkflowDebug?.(currentItem);
  }, [currentItem, onCopyWorkflowDebug, resetIdleTimer]);
  ...
  const canCopyWorkflowDebugCurrent = Boolean(
    currentItem && !isVideo && onCopyWorkflowDebug,
  );
        ...
        {currentItem && (
          <>
            ...
            <MediaViewerActions
              ...
              canCopyWorkflowDebug={canCopyWorkflowDebugCurrent}
              ...
              onCopyWorkflowDebug={handleCopyWorkflowDebugClick}
