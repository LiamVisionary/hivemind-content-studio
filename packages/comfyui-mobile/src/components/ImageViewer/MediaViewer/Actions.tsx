...
import { CopyWorkflowButton } from "@/components/buttons/CopyWorkflowButton";
...
interface MediaViewerActionsProps {
  ...
  isFavorited: boolean;
  canDownload: boolean;
  canCopyWorkflowDebug: boolean;
  loadWorkflowProgress?: number | null;
  onDelete: () => void;
  onLoadWorkflow: () => void;
  onUseInWorkflow: () => void;
  onCopyWorkflowDebug: () => void;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        {canCopyWorkflowDebug && (
          <CopyWorkflowButton onClick={onCopyWorkflowDebug} />
        )}
        {canLoadWorkflow && (
          <LoadWorkflowButton
