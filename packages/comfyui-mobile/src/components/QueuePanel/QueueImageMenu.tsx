    ...
    >
      <ContextMenuBuilder
        items={[
          ...
          {
            key: 'copy-workflow',
            label: 'Copy workflow debug',
            icon: <CopyIcon className="w-4 h-4" />,
            onClick: handleCopyWorkflowClick,
            disabled: loadingWorkflow || (!menuState.workflow && !menuState.promptId)
          },
          {
            key: 'download',
